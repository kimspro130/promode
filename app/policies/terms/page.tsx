      ...
      <div className="bg-secondary/30 rounded-lg p-8 space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-muted-foreground space-y-2">
            ...
            <li>
              ...
              refers to PROMODE, Sector 42, Chandigarh.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to PROMODE, accessible from{" "}
              <a
                href="https://promode.vercel.app"
                rel="noreferrer external nofollow noopener"
                target="_blank"
                className="underline hover:text-primary"
              >
                https://promode.vercel.app
              </a>
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-muted-foreground">
            <li>By email: support@promode.com</li>
          </ul>
        </section>
      </div>
    </div>
