...
// Update the products API to include the shoe products
export async function GET() {
  try {
    // Return mock products data including shoes
    console.log(`Returning ${fallbackProducts.length} mock products`)

    // Convert our Product format to a format that matches what the frontend expects
    ...
    console.error("Error in products API route:", error.message)
